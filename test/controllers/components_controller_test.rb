...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { code: @component.code, date_published: @component.date_published, name: @component.name, value: @component.value, value_max: @component.value_max, value_min: @component.value_min }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { code: @component.code, date_published: @component.date_published, name: @component.name, value: @component.value, value_max: @component.value_max, value_min: @component.value_min }
    assert_redirected_to component_path(assigns(:component))
  end
